package bluetears.test03.alpha.beta.gamma;
...
public class GammaDefaultPage implements HttSaberLily {
	@Override
	public HttSaberResponse doRequest(HttSaberRequest req) throws Exception, HttSaberX {
		...
		res.setBody("<html><body><h1>GammaDefaultPage works!</h1></body></html>".getBytes(StringTools.CHARSET_UTF8));
